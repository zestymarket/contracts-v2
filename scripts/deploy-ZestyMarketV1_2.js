...
async function main() {
  ...
  // zesty nft address
  let zestyNFTAddress = "0xBA7Cd9f08b9a70F05e93025bD26105f2C91aFF0a"

  const ZestyMarket = await hre.ethers.getContractFactory("ZestyMarket_ERC20_V1_2");
  const zestyMarket = await ZestyMarket.deploy(ERC20Address, zestyNFTAddress, MultiSigAddress);
  await zestyMarket.deployed();
  console.log("ZestyMarket_ERC20_V1_2 deployed to:", zestyMarket.address);
}
